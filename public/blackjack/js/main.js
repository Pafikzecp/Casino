    ...
    $.ajax({
        ...
        success: function(data) {
            if (data && typeof data.balance !== 'undefined') {
                currentChipBalance = parseInt(data.balance, 10); // Parse the balance as an integer
...
var currentWager = 0;
var currentChipBalance = localStorage.getItem('blackjackChips') ? parseInt(localStorage.getItem('blackjackChips'), 10) : 500;
